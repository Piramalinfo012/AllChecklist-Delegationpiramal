...
const LoginPage = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyo7fg3XgjpAHjztPI1q_01tR6DN69EZN-gfK81Bq2ae5EPADuR5lrhy6WMjRhavjoVng/exec"
      
      try {
        setIsDataLoading(true)
        
        // Get the spreadsheet ID from your Apps Script
        const SPREADSHEET_ID = "1d7cv-LcuvL5ckeVyXreqB--E2Hp1_HRadzXjiUnIAKs"
